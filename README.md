...
1. Clone the repository using Git:
   ...
   ```bash
   git clone https://github.com/sihabsahariar/Paddle-PPHuman-Onnx.git
   ```

   **OR**

   Download the repository as a ZIP file from [here](https://github.com/sihabsahariar/Paddle-PPHuman-Onnx/archive/main.zip). Extract the ZIP archive.
